...
6. Last step is to download the MySQL dump file by clicking [here] (http://bifacility.uni-koeln.de/GARLIC/garlic_db_dump_06.16.sql.zip), unpack the file and import it to the newly created database using the following command: mysql -u root -p test_significance1 < garlic_db_dump_06.16.sql. 
